...
<div class="card-body row">
  ...
  <div class="tab-content">
      ...
      <div class="row col-sm-12 mt-4">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            @enderror
            <input type="text" value="{{ old('title') }}" class="form-control" name="title" placeholder="Заголовок на русском">
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" placeholder="Seo title" class="form-control" name="seo_title" value="{{ old('seo_title') }}" />
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label>Seo description ru</label>
            <input type="text" placeholder="Seo description" class="form-control" name="seo_description" value="{{ old('seo_description') }}" />
          </div>
        </div>
      ...
      <div class="row col-sm-12 mt-4">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <input type="text" value="{{ old('title_en') }}" class="form-control" name="title_en" placeholder="Заголовок на английском">
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" placeholder="Seo title" class="form-control" name="seo_title_en" value="{{ old('seo_title_en') }}" />
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label>Seo description en</label>
            <input type="text" placeholder="Seo description" class="form-control" name="seo_description_en" value="{{ old('seo_description_en') }}" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row col-sm-12 mt-4">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <input type="text" value="{{ old('title_kz') }}" class="form-control" name="title_kz" placeholder="Заголовок на казахском">
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" placeholder="Seo title" class="form-control" name="seo_title_kz" value="{{ old('seo_title_kz') }}" />
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label>Seo description kz</label>
            <input type="text" placeholder="Seo description" class="form-control" name="seo_description_kz" value="{{ old('seo_description_kz') }}" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row col-sm-12 mt-4">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <input type="text" value="{{ old('title_video') }}" class="form-control" name="title_video" placeholder="Заголовок на казахском">
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <input type="text" value="{{ old('title_video_en') }}" class="form-control" name="title_video_en" placeholder="Заголовок на английском">
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <input type="text" value="{{ old('title_video_kz') }}" class="form-control" name="title_video_kz" placeholder="Заголовок на казахском">
          </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <input type="text" value="{{ old('video') }}" class="form-control" name="video" placeholder="Видео">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row col-sm-12 mt-2">
      ...
      <div class="col-sm-4 mt-4">
        <div class="form-group">
          ...
          <div class="row col-sm">
            ...
            <input type="text" id="feature_image" name="feature_image" value="{{ old('feature_image') }}">
      ...
      <div class="col-sm-12">
        <input type="hidden" value="{{$section}}" name="section_id">
