      ...
      <div class="row col-sm-12 mt-4">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            @enderror
            <input type="text" value="{{ old('title') }}" class="form-control" name="title" placeholder="Вопрос на русском">
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <textarea placeholder="Ответ на русском" class="form-control" name="answer">{{ old('answer') }}</textarea>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row col-sm-12 mt-4">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <input type="text" value="{{ old('title_en') }}" class="form-control" name="title_en" placeholder="Вопрос на казахском">
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <textarea placeholder="Ответ на английском" class="form-control" name="answer_en">{{ old('answer_en') }}</textarea>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row col-sm-12 mt-4">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <input type="text" value="{{ old('title_kz') }}" class="form-control" name="title_kz" placeholder="Вопрос на казахском">
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <span class="error text-danger">{{ $message }}</span>
            @enderror
            <textarea placeholder="Ответ на казахском" class="form-control" name="answer_kz">{{ old('answer_kz') }}</textarea>
          </div>
        </div>
      </div>
    </div>
